...
2026-09-14 기획 연결: [GAME_DESIGN 8절](GAME_DESIGN.md#8-라운드-계획과-시간차-자동-전투)의 라운드 계획·시간차 자동 전투는 목표이며 미구현이다. 본 문서의 활성 유닛·AP/SubAP·진영 이동 제한·접근 중 점유·즉시 피해 및 턴 복구는 기존 순차 전투의 현재 계약이다. 상대 진영 실제 접근·유닛 간 비충돌·발사 후 시전자 사망에도 남는 투사체는 후속 구현 대상으로 구분하며 이번에는 코드·에셋·설정을 변경하지 않는다.
