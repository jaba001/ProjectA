...
| 기준 | 변경·검증 |
|---|---|
| 2026-09-25 상점2 아이템 시험 | 상점1·3 유지, 무기 CSV 295개 가격 1G·원본명·중복 없는 5개 진열·1G 리롤과 개인 아이템 보관·인벤토리 표시 구현. 구매·리롤은 저장 성공 후 반영하고 이어하기에서 복원. UHT 포함 Development Editor / Win64 컴파일·최종 증분 빌드 5.49초·CSV 원본 3열/행 순서·에셋 경로 295개·정적 검사 통과. 게임·자동화 테스트 미실행, [사용자 확인](TODO.md#2-31-상점2-아이템-시험) 대기 |
