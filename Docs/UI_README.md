...
라운드 계획은 상단 중앙 현황과 하단 중앙 조작 패널을 사용한다. 상단은 가로 900·최대 높이 145, 하단은 가로 900·최대 높이 300 UI 단위이며 바깥 여백은 12다. 하단 내용은 스크롤하고 가운데 월드 영역에서 유닛·타일을 선택한다. 이전 좌우 목록 패널은 사용하지 않는다.
