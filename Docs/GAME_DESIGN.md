...
현재 구현은 동일 Gameplay의 두 순차 전투이며 패배 시 Run을 종료한다. 새 Run의 첫 승리 뒤에는 상점1·상점2·상점3을 고정 제시하고 하나를 선택한다. 상점은 이름 표시·퇴장만 제공하며 두 번째 전투로 연결한다. 마지막 승리 뒤에는 기존 Run 종료를 유지한다.
