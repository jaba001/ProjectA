...
갱신일: 2026-09-11 · 대상: T14-7 승계 통합·기본 전투 입력 / T14-8 서비스 준비 · **작동 검증 상태: 사용자 확인 대기**

2026-09-11 사용자 확인: A/B 작동 테스트는 아직 실행하지 않았고 Steam App ID·PlayFab Title도 미준비다. 아래 A~C를 유지하며 먼저 D의 계정 준비부터 진행한다. 이번 재개에서는 문서·설정·엔진 소스만 정적으로 확인했으며 새 컴파일이나 작동 테스트는 수행하지 않았다.
