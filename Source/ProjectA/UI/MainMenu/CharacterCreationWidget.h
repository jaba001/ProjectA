...
private:
    ...
    UPROPERTY(Transient)
    TObjectPtr<UButton> DetailResetBody;
    UPROPERTY(Transient)
    TObjectPtr<UButton> DetailPreviousBody;
    UPROPERTY(Transient)
    TObjectPtr<UButton> DetailNextBody;
    UPROPERTY(Transient)
    TObjectPtr<UTextBlock> DetailBodyName;
    UPROPERTY(Transient)
    TObjectPtr<UTextBlock> DetailBodyPosition;
    UPROPERTY(Transient)
