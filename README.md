...
| 저장 | 비전투 일반 v1/v2·관리 v4 유지. 준비 취소 저장 실패는 기존 버튼으로 재시도. 이전 Combat 저장의 이어하기·재개·새 턴 저장은 거절. 라운드 중간 복구 미지원 |
| 데이터 사전 검사 | 파티 에셋의 Validate Assets에서 기존 직업·스킬 검증과 클래스 fallback을 공유하고 오류 위치 표시. 작동 확인 대기 |
