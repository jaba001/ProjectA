...
개발용 협동: 독립 게임 창 2개에서 MainMenu → 개발용 협동을 연다. 첫 창은 2인 방 생성, 두 번째는 `127.0.0.1:7777`로 참가한다. 각자 준비 완료 후 Host가 시작하고 첫 전투 노드를 선택한다. 창 실행 명령과 4인·이탈 확인 절차는 [테스트 보고서 I](Docs/TEST_REPORT.md#i-개발용-협동-ui)를 따른다.
