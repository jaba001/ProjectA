...
TODO의 우선순위·구현·코드 검토·컴파일·문서·커밋/push는 Codex가 일괄 담당한다. 직접 확인은 싱글 한 Run과 설정 → 2인 협동 → 4인 확대 순서로 묶고, 발견한 문제에 따라 상세 회귀 범위를 좁힌다. 미정 기획의 기본안과 외부 서비스 의존 항목은 [TODO](Docs/TODO.md)에 관리한다.
